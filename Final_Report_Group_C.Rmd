...
```{r echo=FALSE}
t1 <- vif(m2)
test_data = data.frame(VIF = round(t1, 2))
rownames(test_data) = c("Mean Rent", "Distance", "Accomodates", "Review Score - Rating", "Review Score - Cleanliness", "Review Score - Location", "Amenity - TV", "Amenity - Elevator", "Amenity - Dryer")
formattable(test_data, caption = "Table 9: Results Multicollinearity Test")
