...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=5, fig.height=5.5, fig.cap="Figure 6: Non-Linear Relationship between Price and Location"}
data_short %>% ggplot() + geom_point(aes(x = distance, y = price_log), col = "#00E5FFFF", alpha = 0.5) +
  geom_smooth(aes(x = distance, y = price_log), col ="#4C00FFFF") +
  theme_minimal() + xlab("DISTANCE") + ylab("LN(PRICE)")
```
