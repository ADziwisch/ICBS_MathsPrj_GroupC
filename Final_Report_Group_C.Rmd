...
Mapping the mean rent and the logarithmic AirBnB prices according to their location reveals that those variables are related. Nevertheless, it also becomes clear that there is more to an AirBnB price than just the average rent in the particular neighbourhood.
