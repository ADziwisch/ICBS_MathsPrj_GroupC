...
```{r echo=FALSE}
cor.test(as.numeric(data_short$instant_bookable), data_short$price_log, method = "spearman")
ggplot(data = data_short, aes(x = instant_bookable, y = price_log)) + geom_boxplot() + labs(x = "Instant Bookable", y = "Price Per Person") 
...
>>>>>>> 97178597a4d6080cb17ca3a429e7b9a3f32db7f8
