...
t_summary <- data.frame(names = c("Accomodates", "Beds"), p_value = c(fp(t1$p.value), fp(t2$p.value)), conf_low = c(round(t1$conf.int[1], 2), round(t2$conf.int[1], 2)), estimate = c(round(t1$estimate,2), round(t2$estimate,2)), conf_high = c(round(t1$conf.int[2], 2), round(t2$conf.int[2],2)))
