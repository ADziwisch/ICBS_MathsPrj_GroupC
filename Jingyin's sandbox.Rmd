...
library(stargazer)
stargazer(list(m0,m1,m2,m3), type = "text")
...
#kitchen, review_scores_value, washer, lock on bedroom door, instant bookable, cancellation policy
